        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              Making skill sharing effortless and enjoyable. Connect with amazing people, 
              learn new skills, and share your expertise with a global community.
            </p>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-gray-400">
              {navigation.legal.map((item, index) => (
                <span key={item.name}>
                  ...
                  {index < navigation.legal.length - 1 && <span className="ml-6">•</span>}
                </span>
              ))}
            </div>
